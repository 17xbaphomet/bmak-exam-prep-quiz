window.QUESTIONS = (window.QUESTIONS || []).concat([
  {
    ...
    answer: 0,
    explanation: "t ≈ 12.36 > 2.58 → reject. ln(size) is highly significant."
  },
  {
    id: "boee-ht-02",
    type: "mcq",
    ...
    examRelevance: 5,
    source: "PS5",
    question: "Same numbers. Test $H_0:\\beta=0.5$ vs two-sided at 1% (crit = 2.58). t ≈ 3.27. Decision?",
    options: ["Reject $H_0$", "Fail to reject $H_0$", "Inconclusive", "Accept $H_0$"],
    answer: 0,
    explanation: "3.27 > 2.58 → reject. The elasticity is statistically different from 0.5."
  },
  {
    id: "boee-ht-03",
    type: "mcq",
    ...
    examRelevance: 5,
    source: "PS5",
    question: "$\\hat{\\beta}_{view}=0.026$, $se=0.029$, t ≈ 0.90. Two-sided 5% critical value = 1.96. Is view statistically significant (houses without pool)?",
  ...
  },
  {
    ...
    examRelevance: 5,
    source: "PS5",
    question: "Same view coefficient. Test $H_0:\\beta\\le 0$ vs $H_1:\\beta>0$ at 5%. Critical value = 1.64. Decision?",
  ...
  },
  {
    ...
    examRelevance: 5,
    source: "PS5",
    question: "The correct null for “pool, view and interaction are jointly insignificant” is:",
    options: [
      "$H_0: \\beta_{pool}=0$",
